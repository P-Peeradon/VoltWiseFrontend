...
const Advertisement = () => {
    return (
        <figure className="relative w-full flex flex-col">
            ...
            {/* Floating Data Card */}
            <figcaption className="left-12 absolute -bottom-5 max-w-80 p-8 bg-white rounded-xl shadow-xl flex flex-col gap-2">
                <h3 className="text-neutral-700 text-base font-bold uppercase tracking-wide">
                    Current Grid Mix
                </h3>
